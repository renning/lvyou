...
<h3 class="flb">
<em id="return_<?php echo $_G['gp_handlekey'];?>">导入框架</em>
<span>
<?php if($_G['inajax']) { ?><a href="javascript:;" class="flbc" onclick="hideWindow('<?php echo $_G['gp_handlekey'];?>');return false;" title="关闭">关闭</a><?php } ?>
</span>
</h3>
<ul class="tb cl">
<li<?php if(empty($_G['gp_type'])) { ?> class="a"<?php } ?> id="li_import_upload"><a onclick="showWindow('showimport', this.getAttribute('href'));" href="portal.php?mod=portalcp&amp;ac=diy&amp;op=import&amp;type=0&amp;tpl=<?php echo $_GET['tpl'];?>">上传文件</a></li>
<li<?php if($_G['gp_type'] == 1) { ?> class="a"<?php } ?> id="li_import_system"><a onclick="showWindow('showimport', this.getAttribute('href'));" href="portal.php?mod=portalcp&amp;ac=diy&amp;op=import&amp;type=1&amp;tpl=<?php echo $_GET['tpl'];?>">系统内置</a></li>
</ul>

<form name="frameimport" id="frameimport" enctype="multipart/form-data" method="post" autocomplete="off" action="portal.php?mod=portalcp&amp;ac=diy&amp;op=import" onsubmit="ajaxpost('frameimport','return_<?php echo $_G['gp_handlekey'];?>','','onerror',$('frameimportbutton'));">
<div class="c" style="width:420px;line-height:100px; overflow-y: auto; ">
<?php if($_G['gp_type'] == 1) { if($xmlarr) { ?>
选择要导入的文件:

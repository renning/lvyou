...
0
|| checktplrefresh('data/diy/portal/index.htm', './template/default/common/header.htm', 1400943829, 'diy', './data/template/1_diy_portal_index.tpl.php', 'data/diy', 'portal/index')
|| checktplrefresh('data/diy/portal/index.htm', './template/default/common/footer.htm', 1400943829, 'diy', './data/template/1_diy_portal_index.tpl.php', 'data/diy', 'portal/index')
|| checktplrefresh('data/diy/portal/index.htm', './template/default/common/header_common.htm', 1400943829, 'diy', './data/template/1_diy_portal_index.tpl.php', 'data/diy', 'portal/index')
|| checktplrefresh('data/diy/portal/index.htm', './template/default/common/pubsearchform.htm', 1400943829, 'diy', './data/template/1_diy_portal_index.tpl.php', 'data/diy', 'portal/index')
;
block_get('3');?>
...
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framebeyqf6" class="frame move-span cl frame-1-2"><div class="title frame-title"><span class="titletext">1-2框架</span></div><div id="framebeyqf6_left" class="column frame-1-2-l"><div id="framebeyqf6_left_temp" class="move-span temp"></div><?php block_display('3');?></div><div id="framebeyqf6_center" class="column frame-1-2-r"><div id="framebeyqf6_center_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>	</div>

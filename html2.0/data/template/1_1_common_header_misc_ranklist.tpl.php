...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1400943840, '1', './data/template/1_1_common_header_misc_ranklist.tpl.php', './template/default', 'common/header_misc_ranklist')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1400943840, '1', './data/template/1_1_common_header_misc_ranklist.tpl.php', './template/default', 'common/header_misc_ranklist')
;?>

...
0
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header.htm', 1400943159, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/footer.htm', 1400943159, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header_common.htm', 1400943159, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/pubsearchform.htm', 1400943159, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
;
block_get('1,2');?>
...
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frameddlUC1" class="frame move-span cl frame-1-1"><div id="frameddlUC1_left" class="column frame-1-1-l"><div id="frameddlUC1_left_temp" class="move-span temp"></div><?php block_display('1');?></div><div id="frameddlUC1_center" class="column frame-1-1-r"><div id="frameddlUC1_center_temp" class="move-span temp"></div><?php block_display('2');?></div></div></div><!--[/diy]-->
</div>

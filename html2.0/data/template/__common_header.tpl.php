...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1401347400, '', './data/template/__common_header.tpl.php', './template/default', 'common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1401347400, '', './data/template/__common_header.tpl.php', './template/default', 'common/header')
;?>

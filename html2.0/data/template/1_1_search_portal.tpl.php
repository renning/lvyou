...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1400943900, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1400943900, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1400943900, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1400943900, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1400943900, '1', './data/template/1_1_search_portal.tpl.php', './template/default', 'search/portal')
;?>
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" /><?php $keywordenc = $keyword ? rawurlencode($keyword) : '';?><?php if($searchid || ($_G['gp_adv'] && CURMODULE == 'forum')) { ?>
<table id="scform" class="mbm" cellspacing="0" cellpadding="0">
<tr>
<td><h1><a href="search.php" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo IMGDIR;?>/logo_sc.png" alt="<?php echo $_G['setting']['bbname'];?>" /></a></h1></td>
<td>
...
<tr>
<td class="td_srchtxt"><input type="text" id="scform_srchtxt" name="srchtxt" size="45" maxlength="40" value="<?php echo $keyword;?>" tabindex="1" /><script type="text/javascript">initSearchmenu('scform_srchtxt');$('scform_srchtxt').focus();</script></td>
...
<tr>
<td class="td_srchtxt"><input type="text" id="scform_srchtxt" name="srchtxt" size="65" maxlength="40" value="<?php echo $keyword;?>" tabindex="1" /><script type="text/javascript">$('scform_srchtxt').focus();</script></td>
...
<?php if(!empty($_G['setting']['pluginhooks']['portal_bottom'])) echo $_G['setting']['pluginhooks']['portal_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { ?><?php $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">

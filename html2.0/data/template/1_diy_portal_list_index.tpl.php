<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_index');
0
|| checktplrefresh('./template/default/portal/list_index.htm', './template/default/common/header.htm', 1400943908, 'diy', './data/template/1_diy_portal_list_index.tpl.php', './template/default', 'portal/list_index')
|| checktplrefresh('./template/default/portal/list_index.htm', './template/default/common/footer.htm', 1400943908, 'diy', './data/template/1_diy_portal_list_index.tpl.php', './template/default', 'portal/list_index')
|| checktplrefresh('./template/default/portal/list_index.htm', './template/default/common/header_common.htm', 1400943908, 'diy', './data/template/1_diy_portal_list_index.tpl.php', './template/default', 'portal/list_index')
|| checktplrefresh('./template/default/portal/list_index.htm', './template/default/common/pubsearchform.htm', 1400943908, 'diy', './data/template/1_diy_portal_list_index.tpl.php', './template/default', 'portal/list_index')
;?>
...
<div id="wp" class="wp"><!--[name]!portalcategory_indextplname![/name]-->

...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1406604344, '1', './data/template/1_1_common_header_portal_list.tpl.php', './template/default', 'common/header_portal_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1406604344, '1', './data/template/1_1_common_header_portal_list.tpl.php', './template/default', 'common/header_portal_list')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1406604344, '1', './data/template/1_1_common_header_portal_list.tpl.php', './template/default', 'common/header_portal_list')
;?>

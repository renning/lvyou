...
$menu['mudidi'] = array(
		array('beijing', 'yuexiamen_beijing_poi'),
		array('shanghai', 'yuexiamen_shanghai_poi'),
		array(cplang('shandong'), '', 1),
			array('qingdao', 'yuexiamen_qingdao_poi'),
			array('jinan', 'yuexiamen_jinan_poi'),
			array('dezhou', 'yuexiamen_dezhou_poi'),
